...
import ua.com.andromeda.wordgalaxy.core.domain.exception.WordNotMemorizedException
...
fun Word.repeat(): Word {
    val amountRepetition = amountRepetition ?: throw WordNotMemorizedException(value)
